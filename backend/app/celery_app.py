...
celery_app.conf.update(
    ...
    task_routes={
        ...
        'app.tasks.managed_bot_tasks.*': {'queue': 'trading'},
...
celery_app.conf.beat_schedule = {
    ...
    'run-managed-bots-dry-run': {
        'task': 'app.tasks.managed_bot_tasks.run_managed_bots_dry_run',
        'schedule': crontab(minute=os.getenv('MANAGED_BOT_DRY_RUN_CRON_MINUTE', '*/5')),
